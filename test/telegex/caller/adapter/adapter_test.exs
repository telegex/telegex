defmodule Telegex.Caller.AdapterTest do
  ...
  test "Adapter.Req ok" do
    Application.put_env(:telegex, :caller_adapter, Req)
  ...
  test "Adapter.Req error" do
    # 传递选项测试超时错误
    Application.put_env(:telegex, :caller_adapter, {Req, [connect_options: [timeout: 1]]})
